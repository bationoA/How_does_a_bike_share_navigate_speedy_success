---
title: "first_step__extraction_script"
author: "Amos Bationo"
date: "2023-04-21"
...
```{r}
list_folders <- c("data", "downloaded_zip", "outputs", file.path("outputs", "data"), file.path("outputs", "img"))

for (folder_path_name in list_folders){
  # Check if the folder exists
  if (!file.exists(folder_path_name)) {
    # Create the file
    dir.create(folder_path_name)
    }
}
print("Required folders was created!")
```
...
We need to download the all quarters data trips (from 2015Q1 to 2020 Q1) and all data from April (4th month) 2020 to march (3rd month) 2023
